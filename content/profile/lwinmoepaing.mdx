...
<div className="flex flex-col md:flex-row">
  <div className="md:w-6/12 mb-5 flex flex-col justify-center items-center">
    ...
    <p className="text-center text-sm my-2 "><img className="h-5 inline-block mr-1 relative -top-1" src="https://raw.githubusercontent.com/lwinmoepaing/lwinmoepaing/main/img/katto.gif"/>How to reach me **lwinmoepaing.dev@gmail.com (or) [facebook](https://www.facebook.com/lwin.im/)**</p>
  </div>
