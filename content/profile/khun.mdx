...
<p className="text-center mt-2">A junior backend developer @ DAT</p>
...
<div className="container max-w-[720px] mx-auto mt-10">
    ...
    - <a href="https://github.com/KhunPyaePhyoAung" target="_blank"><span className="text-green-500">GitHub</span></a>
    - <a href="mailto:khunpyaephyoaung74@gmail.com"><span className="text-red-300">Mail</span></a>
    - <a href="https://www.facebook.com/profile.php?id=100008700558024" target="_blank"><span className="text-blue-300">Facebook</span></a>
